...
namespace WPM {
	public static class Drawing {
		...
		public static TextMesh CreateText (string text, GameObject parent, int layer, Vector2 center, Font labelFont, Color textColor, bool showShadow, Material shadowMaterial, Color shadowColor, TextAnchor textAnchor = TextAnchor.MiddleCenter) {
			// create base text
